...
<div class="main-content">
    <h2 class="mb-3">{{ ucFirst($status) }} Clients</h2>
            ...
            <tbody>
                @forelse ($clients as $user)
                    <tr>
                        ...
                        <td>{{ optional($user->clientTasks)->count() ?? 0 }}</td>
                                ...
                                <div class="dropdown-menu">
                                    @foreach ($allStatus as $st)
                                        <a class="dropdown-item {{ $user->status == $st['name'] ? 'd-none' : '' }}"
                                           {{-- href="{{ route('adminUpdateClientstatus', ['id' => $user->id, 'status' => $st['name']]) }}" --}}
                                        >
                                            {{ ucFirst($st['name']) }}
                                        </a>
                                    @endforeach
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('singleClient', $user->id) }}"
