        ...
        <div class="row d-none">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{ucFirst($status)}} Freelancers</h4>
                </div>
            </div>
        </div>
        <!-- start page title -->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript: void(0);">Freelancers</a></li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{ucFirst($status)}} Freelancers</h4>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-13 mb-4">
                            This shows the list of freelancers.
                        </p>
                                    ...
                                    @if (count($freelancers) > 0)
                                        @foreach ($freelancers as $user)
                                            <tr>
                                                ...
                                                <td><span class="badge bg-dark">{{ $user->freelancerTaskOffers ? $user->freelancerTaskOffers->count() : 'N/A' }}</span></td>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            @foreach ($allStatus as $status)
                                                                <a class="dropdown-item {{ $user->status == $status['name'] ? 'd-none' : '' }}"
                                                                    {{-- href="{{ route('adminUpdateFreelancerstatus', ['id' => $user->id, 'status' => $status['name']]) }}" --}}
                                                                >
                                                                    {{ ucFirst($status['name']) }}
                                                                </a>
                                                            @endforeach
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-space-between align-items-center">
                                                        ...
                                                        <a
                                                        href="{{ route('singleFreelancer', $user->id) }}"
