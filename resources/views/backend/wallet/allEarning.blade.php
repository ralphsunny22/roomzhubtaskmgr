                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-13 mb-4">
                            This shows the list of earnings.
                        </p>
                        ...
                        <div>
                            <table id="datatable-buttons" class="table table-striped nowrap w-100" style="overflow-x: auto;">
                                ...
                                <tbody>
                                    @if (count($walletEarnings) > 0)
                                        @foreach ($walletEarnings as $item)
                                            <tr>
                                                <td>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            @foreach ($allStatus as $status)
                                                                <a class="dropdown-item {{ $item->status == $status['name'] ? 'd-none' : '' }}"
                                                                    {{-- href="{{ route('adminUpdateEarningstatus', ['id' => $item->id, 'status' => $status['name']]) }}" --}}
                                                                >
                                                                    {{ ucFirst($status['name']) }}
                                                                </a>
                                                            @endforeach
